          ...
          <tbody>
            {filtrados.map((l) => (
              <tr key={l.id} style={{ borderBottom: "1px solid var(--line-soft)" }}>
                ...
                <td className="mono" style={{ padding: "14px 16px", fontSize: 11, color: "var(--dim)" }}>{l.origen}</td>
                <td className="mono" style={{ padding: "14px 16px", fontSize: 11, color: "var(--dim)", whiteSpace: "nowrap" }}>{l.fecha}</td>
                <td className="mono" style={{ padding: "14px 16px", fontSize: 13, color: l.diagnosticos ? "var(--green)" : "var(--dim)" }}>{l.diagnosticos}</td>
              </tr>
            ))}
          </tbody>
        </table>
